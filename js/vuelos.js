var app = new function() {
       ...
       var vuelo2 = {
        ...
        this.mostrarVuelos = function() {
          ...
          if (this.vuelos.length > 0) {
            for (i = 0; i < this.vuelos.length; i++) {
              ...
              data += '<tr>';
              data += '<td>SALA # '+ (i+1) + ' LUGAR ' + this.vuelos[i].origen + ', PELICULA: ' + this.vuelos[i].destino + ', FECHA: ' + this.vuelos[i].hora.toDateString() + " " + hora + ":" + minutos + '</td>';
        ...
        this.Reservar = function (item) {
         ...
         /////////////////////
          var impuesto =  'Impuesto Pelicula'; 
          ...
          document.getElementById('datosvuelo').innerHTML = "SALA # " + (item + 1) + ":<br>LUGAR: " + this.vuelos[item].origen + '<br>PELICULA: ' + this.vuelos[item].destino + '<br>FECHA: ' + this.vuelos[item].hora.toDateString() + " " + hora + ":" + minutos + '<br>PRECIO: $' + this.vuelos[item].costobase + '<br>PRECIO NETO: $' + this.vuelos[item].costoneto + " " + impuesto;
          ...
          document.getElementById('reserva-edit').onsubmit = function() {
            ...
            if (isNaN(d) || d == 0) {
              ...
              if (flag) {
                ...
                window.alert("Su reseva se guardo correctamente");
